<section id="founder" class="block">
        ...
        <div class="founder-grid">
            ...
            <div class="founder-visual object-reveal">
                <div class="visual-frame">
                    ...
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/carolina-eslava.webp" alt="Carolina Eslava - Fundadora" class="founder-photo" loading="lazy">
                </div>
            </div>
                ...
                <div class="founder-methodology object-reveal">
                    ...
                    <div class="methodology-list">
                        ...
                        <div class="methodology-item">
                            ...
                            <div class="item-text">
                                <strong>Métricas y KPIs Cualitativos</strong>
                                <span>Evaluación analítica posterior al simulacro para medir el tiempo de respuesta y efectividad del comité.</span>
                            </div>
                        </div>
                    </div>
                </div>
